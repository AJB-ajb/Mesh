...
| `1-nested-postings.md` | 1 | Nesting model, context inheritance, groups/channels |
...
| New feature | `0-vision.md` + relevant `1-*` files + `2-roadmap.md` |
...
- **Shape A — Insight-driven**: vision, text-first, nested-postings, posting-access, matching, skills. Lead with "why", then "how".
