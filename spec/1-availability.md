...
| 3     | Google Calendar OAuth + FreeBusy sync. Busy block overlay. Effective availability in matching. | Partial (OAuth + sync + busy blocks done; effective availability in matching not yet wired) |
