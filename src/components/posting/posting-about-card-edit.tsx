...
// ---------------------------------------------------------------------------
// LocationEditFields — geolocation + autocomplete for location editing
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// PostingAboutCardEdit — form editing for the about card
// ---------------------------------------------------------------------------

export function PostingAboutCardEdit({
  form,
  onFormChange,
}: {
  form: PostingFormState;
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) => onFormChange("contextIdentifier", e.target.value)}
            placeholder="e.g., CS101, HackMIT 2026"
          />
        </div>
        <div className="space-y-2">
          <label className="text-sm font-medium">Min Skill Level (0-10)</label>
          <Input
            type="number"
            min={0}
            max={10}
        ...
        <div className="flex items-center gap-3 sm:col-span-2">
          <input
            ...
            onChange={(e) =>
              onFormChange("autoAccept", e.target.checked ? "true" : "false")
            }
