...
export const labels = {
  ...
  spaces: {
    ...
    archiveConfirm:
      "Are you sure? The space will be hidden from the main list.",
    ...
    posting: {
      ...
      deletePosting: "Delete posting",
      save: "Save",
      promote: "Promote to Explore",
      promoteSuccess: "Promoted to Explore",
    },
    thread: {
  ...
  cards: {
    ...
    rsvpTitle: "Event title",
    rsvpTitlePlaceholder: "What's the event?",
    rsvpThresholdLabel: "Minimum confirmations needed",
    createRsvpSubmit: "Create RSVP",
    createTaskClaim: "Create Task",
    taskDescription: "Task description",
    taskDescriptionPlaceholder: "What needs to be done?",
    createTaskClaimSubmit: "Create Task",
    createLocation: "Suggest Location",
